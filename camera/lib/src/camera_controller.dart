...
typedef onLastestPointAvailable = Function(Points points);
...
class CameraController extends ValueNotifier<CameraValue> {
  ...
  Future<void> startImageStream(onLastestPointAvailable onAvailable) async {
    ...
    _imageStreamSubscription =
      ...
      (dynamic imageData) {
        ...
        onAvailable(Points.fromPlatformPoint(imageData));
      },
    );
  }
