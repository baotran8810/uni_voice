...
public class MathUtils {
    ...
    public static float getBearing(double latitude1, double longitude1, double latitude2,
        ...
        return (float) (Math.toDegrees(bearing) % 360.0f);
    }
    ...
    public static double bearingToLocation(float heading, Location currentLocation, Location destinationLocation) {
        double lat1 = DegreesToRadians(currentLocation.getLatitude());
        double lon1 = DegreesToRadians(currentLocation.getLongitude());

        double lat2 = DegreesToRadians(destinationLocation.getLatitude());
        double lon2 = DegreesToRadians(destinationLocation.getLongitude());
        ...
        return (360 - heading + RadiansToDegrees(radiansBearing)) % 360;
    }
}
